var Browser = {};
Browser.DOM = function (html, scope, cleanHTML) {
  var node = html;
...
StateManager.setStatePipe = function(data){
...
DataStore.prototype.createSingleStore = function(id){
  if (!this.stores[id]) {
      ...
      ADD_STATE_MANAGER(this.stores[id]);
  }
...
DataStore.prototype.getStore = function(id){
return this.createSingleStore(id);
}
DataStore.prototype.setState = function(id, data){
  this.getStore(id).setState(data);
}
DataStore.prototype.setStatePipe = function(id, data){
    this.getStore(id).setStatePipe(data);
  }

DataStore.prototype.unsubscribe = function(id, callback){
...
DataStore.prototype.subscribe = function(id, callback){
  this.createSingleStore(id);
  this.stores[id].subscribers.push(callback);
}
DataStore.prototype.clear = function(id) {
