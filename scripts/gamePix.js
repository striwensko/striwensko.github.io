(function(){
    ...
    SVG.puzzles = '<svg width="21px" height="20px" viewBox="0 0 21 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="Icon-/-Puzzle" transform="translate(-2.000000, -2.000000)" fill="#FFFFFF"><path d="M16.3513989,19.7894695 C16.9036837,19.7894695 17.3513989,19.3417542 17.3513989,18.7894695 L17.3513989,14.2635157 L19.3257815,14.2635157 C19.8780663,14.2635157 20.3257815,13.8158004 20.3257815,13.2635157 L20.3257815,12.7447193 C20.3257815,12.1924345 19.8780663,11.7447193 19.3257815,11.7447193 L17.3513989,11.7447193 L17.3513989,7.9104824 C17.3513989,7.35819765 16.9036837,6.9104824 16.3513989,6.9104824 L12.1713036,6.9104824 L12.1713036,5.21053052 C12.1713036,4.65824577 11.7235883,4.21053052 11.1713036,4.21053052 L10.6525072,4.21053052 C10.1002224,4.21053052 9.65250716,4.65824577 9.65250716,5.21053052 L9.65250716,6.9104824 L5.47241183,6.9104824 C4.92012708,6.9104824 4.47241183,7.35819765 4.47241183,7.9104824 L4.47241183,9.7447193 L5.08918493,9.7447193 C6.74603918,9.7447193 8.08918493,11.087865 8.08918493,12.7447193 L8.08918493,13.2635157 C8.08918493,14.9203699 6.74603918,16.2635157 5.08918493,16.2635157 L4.47241183,16.2635157 L4.47241183,18.7894695 C4.47241183,19.3417542 4.92012708,19.7894695 5.47241183,19.7894695 L7.65255065,19.7894695 C7.6613391,18.1401268 9.0010982,16.8057951 10.6525072,16.8057951 L11.1713036,16.8057951 C12.8227125,16.8057951 14.1624716,18.1401268 14.1712601,19.7894695 L16.3513989,19.7894695 Z M19.3513989,9.74482639 C20.9964583,9.75858591 22.3257815,11.0964126 22.3257815,12.7447193 L22.3257815,13.2635157 C22.3257815,14.9118224 20.9964583,16.2496491 19.3513989,16.2634086 L19.3513989,18.7894695 C19.3513989,20.4463237 18.0082532,21.7894695 16.3513989,21.7894695 L12.1713036,21.7894695 L12.1713036,19.8057951 C12.1713036,19.2535104 11.7235883,18.8057951 11.1713036,18.8057951 L10.6525072,18.8057951 C10.1002224,18.8057951 9.65250716,19.2535104 9.65250716,19.8057951 L9.65250716,21.7894695 L5.47241183,21.7894695 C3.81555758,21.7894695 2.47241183,20.4463237 2.47241183,18.7894695 L2.47241183,14.2635157 L5.08918493,14.2635157 C5.64146968,14.2635157 6.08918493,13.8158004 6.08918493,13.2635157 L6.08918493,12.7447193 C6.08918493,12.1924345 5.64146968,11.7447193 5.08918493,11.7447193 L2.47241183,11.7447193 L2.47241183,7.9104824 C2.47241183,6.25362815 3.81555758,4.9104824 5.47241183,4.9104824 L7.66732451,4.9104824 C7.81786413,3.39450866 9.09691919,2.21053052 10.6525072,2.21053052 L11.1713036,2.21053052 C12.7268915,2.21053052 14.0059466,3.39450866 14.1564862,4.9104824 L16.3513989,4.9104824 C18.0082532,4.9104824 19.3513989,6.25362815 19.3513989,7.9104824 L19.3513989,9.74482639 Z" id="Combined-Shape"></path></g></g></svg>';
    ...
    function start(){
        ...
        function renderUI(){
            ...
            */
            ...
            UI['close-button'].style.display = 'block';
            ...
            UI.button.gamePad.style.opacity = '0';
            UI.button.children[1].style.position = 'absolute';
            UI.button.children[1].style.top = '50%';
            UI.button.children[1].style.left = '50%';
            UI.button.children[1].style.transform = 'translate(-50%, -50%)';
            UI.button.children[1].children[0].style.marginTop = '2px';
            UI.button.children[1].children[0].style.fill = '#fff';
            ...
            timeLine.onRender = function(){
                ...
                if (this.direction == -1){
                    ...
                    var startX = UI.button.startX || 0;
                    TimeLine.applyMatrix(UI.button, {x: startX + (-48 - startX) * this.getTime(300, 200)});
                }
                
                if (timeLine.position == timeLine.duration){
                    UI.button.PREV_CYCLE = - 50000;
                }
            ...
            UI.button.timeLine.render = function(){
                ...
                if (timeLine.position == 0 && iframe.style.display == 'none'){
                    ...
                    var opacity = Math.min(Math.max(0, ((this.position - UI.button.HIDE_GAME_PAGE) / 200)), 1);
                    UI.button.gamePad.style.opacity = (1 - opacity);
                }
            ...
            html = '';
            html += '<div style="color:#fff;position:absolute; top: 0; left: 0;" var="text"></div>'
            ...
            json.onData = function(){
                ...
                /*
                *   For rendering the 3 menu item just comment this out and push the 3 games to items array
                */
